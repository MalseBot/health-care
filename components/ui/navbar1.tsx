      ...
      items: [
        {
          ...
          description: "name, date, time,number, age",
          icon: <BookPlus className="size-5 shrink-0" />,
          url: "/dashboard/add",
        },
        {
          title: "Calender",
        ...
        {
          title: "Archive",
          description: "view all archived appointments",
...
const renderMenuItem = (item: MenuItem) => {
  ...
  return (
    <NavigationMenuItem key={item.title}>
      <NavigationMenuLink
        href={item.url}
        className="group inline-flex h-10 w-max items-center justify-center rounded-md  px-4 py-2 text-sm font-medium transition-colors hover:bg-primary bg-secondary hover:text-text"
      >
        {item.title}
      </NavigationMenuLink>
    </NavigationMenuItem>
